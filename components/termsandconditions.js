...
<div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <p className="mb-3 text-gray-600">These terms and conditions outline the rules and regulations for the use of Bham Web Design and SEO Co.s Website, located at <a href="https://bhamseoanddesignco.com" className="text-blue-600 hover:text-blue-800 transition duration-300">https://bhamseoanddesignco.com</a>.</p>
    <p className="text-gray-600 mb-4">By accessing this website we assume you accept these terms and conditions. Do not continue to use Bham Web Design and SEO Co. if you do not agree to take all of the terms and conditions stated on this page.</p>
    ...
    <li>Sell, rent or sub-license material from Bham Web Design and SEO Co.</li>
    <li>Reproduce, duplicate or copy material from Bham Web Design and SEO Co.</li>
    <li>Redistribute content from Bham Web Design and SEO Co.</li>
    </ul>
