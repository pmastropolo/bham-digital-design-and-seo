...
const WebDesignIrondale = () => {
    return (
        <>
            <NextSeo
                title="Web Design Services in Irondale, AL | Bham Web Design and SEO Co."
                description="Bham Web Design and SEO Co. offers top-notch web design services in Irondale, AL. Explore our customized web solutions designed to elevate your Irondale business's online presence."
                openGraph={{
                    title: 'Web Design Services in Irondale, AL | Bham Web Design and SEO Co.',
                    description: 'Bham Web Design and SEO Co. offers top-notch web design services in Irondale, AL. Explore our customized web solutions designed to elevate your Irondale businesss online presence.',
                    url: 'https://bhamseoanddesignco.com/web-design-irondale-al',
                    type: 'website',
                }}
            />
   <div className="bg-gradient-to-br from-slate-950 to-indigo-950 text-center py-12 px-6 shadow-xl rounded-2xl mt-10 mb-12 transform hover:scale-105 transition duration-500 ease-in-out relative overflow-hidden">
    ...
    <div className="py-4 px-6 mb-4 md:mb-6 mt-4 bg-white bg-opacity-20 rounded-lg">
        <p className="text-lg md:text-xl text-white">
            ...
            The name was taken from a furance located just west of what now is the city limits of Irondale.
        </p>
    </div>
...
<p className="text-gray-600">Zip Codes | <span className="text-indigo-900">35210, 35213, 35223</span></p>
        ...
        <Link href="/PackagePage" legacyBehavior>
                    <a className="inline-block bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded transition duration-300">
                        Elevate Your Irondale Business Online
                    </a>
                    </Link>
                </div>
            </div>
...
export default WebDesignIrondale;
