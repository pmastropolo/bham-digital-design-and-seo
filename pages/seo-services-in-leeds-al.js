...
<p className="text-gray-600 text-left"><b>Zip Codes</b> : <span className="font-semibold text-indigo-900">35004 | 35094 | 35173</span></p>
        ...
        <Link href="/seopackagepage" legacyBehavior>
                    <a className="inline-block bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded transition duration-300">
                        Elevate Your Leeds Business Online
                    </a>
                    </Link>
                </div>
            </div>
...
<h2 className="text-5xl font-bold text-gray-800 mb-5 text-center">Elevate Your Leeds Business with SEO</h2>
