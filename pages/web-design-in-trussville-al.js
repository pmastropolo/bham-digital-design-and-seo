...
const WebDesignTrussville = () => {
    return (
        <>
            <NextSeo
                title="Web Design Services in Trussville, AL | Bham Web Design and SEO Co."
                description="Bham Web Design and SEO Co. specializes in web design services in Trussville, AL. Explore our customized web solutions designed to enhance your online presence in Trussville."
                openGraph={{
                    title: 'Web Design Services in Trussville, AL | Bham Web Design and SEO Co.',
                    description: 'Bham Web Design and SEO Co. specializes in web design services in Trussville, AL. Explore our customized web solutions designed to enhance your online presence in Trussville.',
                    url: 'https://bhamseoanddesignco.com/web-design-trussville-al',
                    type: 'website',
                }}
            />
    ...
    <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-700 via-white to-indigo-200 my-4 animate-gradient">
        Web Design Services in Trussville, AL
    </h1>
...
export default WebDesignTrussville;
