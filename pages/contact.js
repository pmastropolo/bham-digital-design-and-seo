    ...
    <>
      ...
      <div className="bg-gray-100 min-h-screen">
        ...
        <header className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 py-4">
          <div className="container mx-auto text-white text-center max-w-xl">
        ...
        <section className="container mx-auto py-8">
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-md shadow-lg">
            ...
            <p className="mb-6">
              Please fill out the form below to get in contact with us. If you dont have information for some lines, you can keep them <span style={{ textDecoration: 'underline' }}>blank</span>.
            </p>
