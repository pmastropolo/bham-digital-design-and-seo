...
const WebDesignHueytown = () => {
    return (
        <>
            <NextSeo
                title="Web Design Services in Hueytown, AL | Bham Web Design and SEO Co."
                description="Bham Web Design and SEO Co. specializes in web design services in Hueytown, AL. Discover our customized web solutions designed to enhance your online presence in Hueytown."
                openGraph={{
                    title: 'Web Design Services in Hueytown, AL | Bham Web Design and SEO Co.',
                    description: 'Bham Web Design and SEO Co. specializes in web design services in Hueytown, AL. Discover our customized web solutions designed to enhance your online presence in Hueytown.',
                    url: 'https://bhamseoanddesignco.com/web-design-hueytown-al',
                    type: 'website',
                }}
            />
<div className="bg-white text-center p-10 shadow-lg rounded-lg mb-10 z-10 relative">
    <h2 className="text-5xl font-extrabold text-gray-800 mt-4 mb-6">Web Design Services in Hueytown, AL</h2>
...
<p className="mb-3 text-indigo-500"><b className="underline text-lg"><a href="https://bobsykes.com/">Bob Sykes Bar-B-Q</a></b><br></br>Legendary barbecue restaurant in Bessemer known for its authentic Southern dishes.</p>
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg flex flex-wrap md:flex-nowrap">
        {/* Text Section */}
        <div className="w-full md:w-1/2 text-gray-700">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Elevate Your Business in Hueytown with Our Web Design Expertise</h2>
            <p>In the digital age, a compelling online presence is more than just a luxury. Its a necessity. At Bham Web Design and SEO Co., we understand the heartbeat of Hueytown, AL. Our web design solutions are not just aesthetically pleasing but also strategically crafted to meet the unique needs and goals of your local business.</p>
...
export default WebDesignHueytown;
